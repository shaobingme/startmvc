...
<div id="think_page_trace" style="display:none;position:fixed;bottom:0;right:0;font-size:14px;width:100%;z-index:999999;color:#333;text-align:left;background:#f8f9fa;border-top:1px solid #e9ecef;box-shadow:0 -2px 4px rgba(0,0,0,.05);">
    <div style="padding:10px;">
        ...
        <div style="display:flex;border-bottom:1px solid #e9ecef;margin-bottom:10px;">
            <div id="tab-base" class="trace-tab active" style="padding:6px 12px;cursor:pointer;margin-right:5px;border-radius:4px 4px 0 0;background:#1a73e8;color:#fff;">基础信息</div>
            <div id="tab-request" class="trace-tab" style="padding:6px 12px;cursor:pointer;margin-right:5px;border-radius:4px 4px 0 0;">请求</div>
            <div id="tab-sql" class="trace-tab" style="padding:6px 12px;cursor:pointer;margin-right:5px;border-radius:4px 4px 0 0;">SQL查询</div>
            <div id="tab-file" class="trace-tab" style="padding:6px 12px;cursor:pointer;margin-right:5px;border-radius:4px 4px 0 0;">加载文件</div>
            <div id="tab-config" class="trace-tab" style="padding:6px 12px;cursor:pointer;margin-right:5px;border-radius:4px 4px 0 0;">配置</div>
            <div id="tab-error" class="trace-tab" style="padding:6px 12px;cursor:pointer;margin-right:5px;border-radius:4px 4px 0 0;">错误</div>
        ...
        <!-- 基础信息面板 -->
        <div id="panel-base" class="trace-panel" style="display:block;height:250px;overflow-y:auto;">
            <div style="display:flex;flex-wrap:wrap;gap:10px;">
                ...
                <div style="background:#fff;padding:8px 15px;border-radius:4px;border:1px solid #e9ecef;">
                    <span style="color:#666;">控制器：</span>
                    <span style="color:#1a73e8;font-weight:bold;"><?php echo isset($_GET['c']) ? $_GET['c'] : 'index'; ?></span>
                </div>
                <div style="background:#fff;padding:8px 15px;border-radius:4px;border:1px solid #e9ecef;">
                    <span style="color:#666;">方法：</span>
                    <span style="color:#1a73e8;font-weight:bold;"><?php echo isset($_GET['a']) ? $_GET['a'] : 'index'; ?></span>
                </div>
                <div style="background:#fff;padding:8px 15px;border-radius:4px;border:1px solid #e9ecef;">
                    <span style="color:#666;">PHP版本：</span>
                    <span style="color:#1a73e8;font-weight:bold;"><?php echo PHP_VERSION; ?></span>
                </div>
                <div style="background:#fff;padding:8px 15px;border-radius:4px;border:1px solid #e9ecef;">
                    <span style="color:#666;">服务器：</span>
                    <span style="color:#1a73e8;font-weight:bold;"><?php echo $_SERVER['SERVER_SOFTWARE']; ?></span>
                </div>
            </div>
        </div>
        
        <!-- 请求信息面板 -->
        <div id="panel-request" class="trace-panel" style="display:none;height:250px;overflow-y:auto;">
            <div style="display:flex;flex-wrap:wrap;gap:12px;">
                <!-- GET参数 -->
                <div style="flex:1;min-width:300px;">
                    <div style="font-weight:bold;padding:5px 0;color:#1a73e8;border-bottom:1px solid #e9ecef;margin-bottom:5px;">GET参数</div>
                    <div style="background:#fff;border-radius:4px;border:1px solid #e9ecef;max-height:70px;overflow-y:auto;">
                        <?php if(empty($_GET)): ?>
                            <div style="padding:8px 12px;color:#666;font-style:italic;">无GET参数</div>
                        <?php else: ?>
                            <?php foreach($_GET as $key => $value): ?>
                            <div style="padding:5px 12px;border-bottom:1px solid #f0f0f0;font-size:13px;">
                                <span style="color:#666;font-weight:bold;"><?php echo htmlspecialchars($key); ?>: </span>
                ...
                <!-- POST参数 -->
                <div style="flex:1;min-width:300px;">
                    <div style="font-weight:bold;padding:5px 0;color:#1a73e8;border-bottom:1px solid #e9ecef;margin-bottom:5px;">POST参数</div>
                    <div style="background:#fff;border-radius:4px;border:1px solid #e9ecef;max-height:70px;overflow-y:auto;">
                        <?php if(empty($_POST)): ?>
                            <div style="padding:8px 12px;color:#666;font-style:italic;">无POST参数</div>
                        <?php else: ?>
            ...
            <div style="margin-top:12px;">
                <div style="font-weight:bold;padding:5px 0;color:#1a73e8;border-bottom:1px solid #e9ecef;margin-bottom:5px;">请求头</div>
                <div style="background:#fff;border-radius:4px;border:1px solid #e9ecef;max-height:70px;overflow-y:auto;">
                    <?php 
                    $headers = function_exists('getallheaders') ? getallheaders() : [];
                    if(empty($headers)): ?>
                        <div style="padding:8px 12px;color:#666;font-style:italic;">无法获取请求头信息</div>
                    <?php else: ?>
                        <?php foreach($headers as $key => $value): ?>
                        <div style="padding:5px 12px;border-bottom:1px solid #f0f0f0;font-size:13px;">
                            <span style="color:#666;font-weight:bold;"><?php echo htmlspecialchars($key); ?>: </span>
                            <span style="word-break:break-all;"><?php echo htmlspecialchars($value); ?></span>
                        </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </div>
            ...
            <!-- Cookie信息 -->
            <div style="margin-top:12px;">
                <div style="font-weight:bold;padding:5px 0;color:#1a73e8;border-bottom:1px solid #e9ecef;margin-bottom:5px;">Cookie</div>
                <div style="background:#fff;border-radius:4px;border:1px solid #e9ecef;max-height:50px;overflow-y:auto;">
                    <?php if(empty($_COOKIE)): ?>
                        <div style="padding:8px 12px;color:#666;font-style:italic;">无Cookie数据</div>
                    <?php else: ?>
        ...
        <!-- SQL查询面板 -->
        <div id="panel-sql" class="trace-panel" style="display:none;height:250px;overflow-y:auto;">
            <div style="background:#fff;border-radius:4px;border:1px solid #e9ecef;">
                <?php 
                // 只有在需要使用时才加载
        ...
        <!-- 加载文件面板 -->
        <div id="panel-file" class="trace-panel" style="display:none;height:250px;overflow-y:auto;">
            <div style="background:#fff;border-radius:4px;border:1px solid #e9ecef;">
                <?php 
                $files = get_included_files();
                foreach($files as $index => $file): ?>
                <div style="padding:4px 12px;<?php echo $index % 2 ? 'background:#f8f9fa;' : ''; ?> font-size:13px;line-height:1.4;">
        ...
        <!-- 配置信息面板 -->
        <div id="panel-config" class="trace-panel" style="display:none;height:250px;overflow-y:auto;">
            <div style="display:flex;flex-wrap:wrap;gap:12px;">
                <!-- 系统配置 -->
                <div style="flex:1;min-width:300px;">
                    <div style="font-weight:bold;padding:5px 0;color:#1a73e8;border-bottom:1px solid #e9ecef;margin-bottom:5px;">系统配置</div>
                    <div style="background:#fff;border-radius:4px;border:1px solid #e9ecef;max-height:70px;overflow-y:auto;">
                        <?php
                        // 常见关键配置项
                        $keyConfigs = [
                        ...
                        ?>
                        <div style="padding:5px 12px;border-bottom:1px solid #f0f0f0;font-size:13px;">
                            <span style="color:#666;font-weight:bold;"><?php echo $key; ?>: </span>
                ...
                <!-- 缓存状态 -->
                <div style="flex:1;min-width:300px;">
                    <div style="font-weight:bold;padding:5px 0;color:#1a73e8;border-bottom:1px solid #e9ecef;margin-bottom:5px;">缓存状态</div>
                    <div style="background:#fff;border-radius:4px;border:1px solid #e9ecef;max-height:70px;overflow-y:auto;">
                        <?php
                        // 检查常见的缓存扩展
                        $cacheExtensions = [
                        ...
                        ?>
                        <div style="padding:5px 12px;border-bottom:1px solid #f0f0f0;font-size:13px;">
                            <span style="color:#666;font-weight:bold;"><?php echo $cache; ?>: </span>
                        ...
                        <!-- 自动加载信息 -->
                        <div style="padding:5px 12px;border-bottom:1px solid #f0f0f0;font-size:13px;">
                            <span style="color:#666;font-weight:bold;">Autoload: </span>
                        ...
                        <!-- 会话状态 -->
                        <div style="padding:5px 12px;border-bottom:1px solid #f0f0f0;font-size:13px;">
                            <span style="color:#666;font-weight:bold;">Session: </span>
                            <span style="color:#1a73e8;word-break:break-all;">
                                <?php 
            ...
            <!-- 框架配置 -->
            <div style="margin-top:12px;">
                <div style="font-weight:bold;padding:5px 0;color:#1a73e8;border-bottom:1px solid #e9ecef;margin-bottom:5px;">框架配置</div>
                <div style="background:#fff;border-radius:4px;border:1px solid #e9ecef;max-height:70px;overflow-y:auto;">
                    <?php
                    // 获取可显示的配置信息
                    $configs = [];
                    ...
                    <?php endforeach; ?>
                    <?php else: ?>
                    <div style="padding:8px 12px;color:#666;font-style:italic;">无法获取框架配置信息</div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <!-- 错误信息面板 -->
        <div id="panel-error" class="trace-panel" style="display:none;height:250px;overflow-y:auto;">
            <?php
            // 获取错误信息
            $hasErrors = false;
            ?>
            ...
            <div style="margin-bottom:12px;">
                <div style="font-weight:bold;padding:5px 0;color:#dc3545;border-bottom:1px solid #e9ecef;margin-bottom:5px;">异常信息</div>
                <div style="background:#fff;border-radius:4px;border:1px solid #e9ecef;max-height:90px;overflow-y:auto;">
                    <?php 
                    // 检查是否有捕获的异常
                    ...
                    ?>
                    <div style="padding:8px 12px;<?php echo $index % 2 ? 'background:#f8f9fa;' : ''; ?> border-bottom:1px solid #f0f0f0;">
                    ...
                    <?php endforeach; ?>
                    <?php else: ?>
                    <div style="padding:8px 12px;color:#28a745;font-style:italic;">未捕获到异常</div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <!-- 错误信息 -->
            <div>
                <div style="font-weight:bold;padding:5px 0;color:#dc3545;border-bottom:1px solid #e9ecef;margin-bottom:5px;">错误信息</div>
                <div style="background:#fff;border-radius:4px;border:1px solid #e9ecef;max-height:90px;overflow-y:auto;">
                    <?php
                    // 检查是否有错误信息
                    ...
                    <?php endforeach; ?>
                    <?php else: ?>
                    <div style="padding:8px 12px;color:#28a745;font-style:italic;">未发现错误</div>
                    <?php endif; ?>
                </div>
            </div>
...
(function(){
    ...
    // 面板显示隐藏效果
    trace.style.transition = 'transform 0.3s ease';
