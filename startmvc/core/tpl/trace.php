...
<div id="think_page_trace">
	<div style="padding:10px;">
		...
		<div style="display:flex;border-bottom:1px solid #e9ecef;margin-bottom:10px;">
			...
			<div style="margin-left:auto;display:flex;align-items:center;">
				<span class="trace-meta">
					总耗时: <span class="trace-ok"><?php echo isset(App::$trace['runtime']) ? App::$trace['runtime'] : '未记录'; ?></span>
				</span>
				<span class="trace-meta">
					内存: <span class="trace-ok"><?php echo isset(App::$trace['memory']) ? App::$trace['memory'] : '未记录'; ?></span>
				</span>
			</div>
		</div>
		...
		<div id="panel-base" class="trace-panel trace-panel-active">
			<div class="trace-flex-cols" style="gap:10px;">
				<div class="trace-item">
					<span class="trace-item-title">请求方法：</span>
					<span class="trace-item-content"><?php echo htmlspecialchars(isset($_SERVER['REQUEST_METHOD']) ? $_SERVER['REQUEST_METHOD'] : ''); ?></span>
				</div>
				<div class="trace-item">
					<span class="trace-item-title">请求URI：</span>
					<span class="trace-item-content"><?php echo htmlspecialchars(isset($_SERVER['REQUEST_URI']) ? $_SERVER['REQUEST_URI'] : ''); ?></span>
				</div>
				<div class="trace-item">
					<span class="trace-item-title">控制器：</span>
					<span class="trace-item-content"><?php echo htmlspecialchars(isset($_GET['c']) ? $_GET['c'] : 'index'); ?></span>
				</div>
				<div class="trace-item">
					<span class="trace-item-title">方法：</span>
					<span class="trace-item-content"><?php echo htmlspecialchars(isset($_GET['a']) ? $_GET['a'] : 'index'); ?></span>
				</div>
				<div class="trace-item">
				...
				<div class="trace-item">
					...
					<span class="trace-item-content"><?php echo htmlspecialchars(isset($_SERVER['SERVER_SOFTWARE']) ? $_SERVER['SERVER_SOFTWARE'] : ''); ?></span>
				</div>
			</div>
		</div>
		...
		<div id="panel-request" class="trace-panel">
			<div class="trace-flex-cols">
				...
				<div class="trace-col">
					...
					<div class="trace-block-container">
						<?php if(empty($_POST)): ?>
							<div class="trace-row trace-empty">无POST参数</div>
						<?php else: ?>
			...
			<div class="trace-block">
				...
				<div class="trace-block-container">
					...
					if(empty($headers)): ?>
						<div class="trace-row trace-empty">无法获取请求头信息</div>
					<?php else: ?>
			...
			<div class="trace-block">
				...
				<div class="trace-block-container">
					<?php if(empty($_COOKIE)): ?>
						<div class="trace-row trace-empty">无Cookie数据</div>
					<?php else: ?>
		...
		<div id="panel-sql" class="trace-panel">
			<div class="trace-block-container trace-container-lg">
				<?php 
				// 只有在需要使用时才加载
				...
				if (!empty($sqlLogs)): 
					...
					<div class="trace-row">
						<div style="display:flex;justify-content:space-between;align-items:flex-start;gap:15px;">
							<span class="trace-mono"><?php echo htmlspecialchars($sql['sql']); ?></span>
						...
						<div class="trace-detail" style="margin-top:4px;padding-left:20px;word-break:break-all;">
				...
				<?php else: ?>
					<div class="trace-row trace-empty">暂无SQL操作记录</div>
				<?php endif; ?>
			</div>
		</div>
		...
		<div id="panel-config" class="trace-panel">
				...
				<div class="trace-col">
					...
					<div class="trace-block-container">
						...
						<div class="trace-row">
							...
							<span class="trace-key"><?php echo $value; ?></span>
						</div>
						<?php endforeach; ?>
					</div>
				</div>
			...
			<div class="trace-block">
				...
				<div class="trace-block-container">
					...
					<?php endforeach; ?>
					<?php else: ?>
					<div class="trace-row trace-empty">无法获取框架配置信息</div>
					<?php endif; ?>
				</div>
			</div>
		</div>
		...
		<div id="panel-error" class="trace-panel">
			...
			<!-- 捕获的异常 -->
			<div class="trace-block">
				<div class="trace-block-title trace-err">异常信息</div>
				<div class="trace-block-container trace-container-sm">
					<?php 
					// 检查是否有捕获的异常
					...
					?>
					<div class="trace-row">
						<div class="trace-err trace-pad" style="font-weight:bold;"><?php echo get_class($exception); ?></div>
						<div class="trace-pad"><?php echo $exception->getMessage(); ?></div>
						<div class="trace-detail">
							位于: <?php echo $exception->getFile(); ?>:<?php echo $exception->getLine(); ?>
						</div>
						<div class="trace-detail" style="margin-top:5px;font-family:monospace;white-space:pre-wrap;">
							<?php 
							// 显示简化的堆栈信息
					...
					<?php endforeach; ?>
					<?php else: ?>
					<div class="trace-row trace-ok-plain trace-empty">未捕获到异常</div>
					<?php endif; ?>
				</div>
			</div>
			...
			<!-- 错误信息 -->
			<div class="trace-block">
				<div class="trace-block-title trace-err">错误信息</div>
				<div class="trace-block-container trace-container-sm">
					<?php
					// 检查是否有错误信息
					...
					?>
					<div class="trace-row">
						<div class="trace-pad" style="color:<?php echo $errorColor; ?>;font-weight:bold;">[<?php echo $errorTypeStr; ?>]</div>
						<div class="trace-pad"><?php echo isset($error['message']) ? $error['message'] : ''; ?></div>
						<div class="trace-detail">
					...
					<?php endforeach; ?>
					<?php else: ?>
					<div class="trace-row trace-ok-plain trace-empty">未发现错误</div>
					<?php endif; ?>
				</div>
			</div>
			
			<?php if (!$hasErrors): ?>
			<div style="text-align:center;margin-top:20px;" class="trace-ok-plain">
